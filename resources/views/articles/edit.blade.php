                    ...
                    <form method="post" action="{{ route('articles.update', $article->slug) }}"
                        ...
                        <div>
                            ...
                            <textarea name="excerpt"
                                class="mt-1 block w-full h-20 border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm"> {{ $article->excerpt }} </textarea>
                            @error('excerpt')
                                <div class="text-red-500">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="description"
                                class="mt-1 block w-full h-40 border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm"> {{ $article->description }} </textarea>
                            @error('description')
                                <div class="text-red-500">{{ $message }}</div>
                            @enderror
                        </div>
