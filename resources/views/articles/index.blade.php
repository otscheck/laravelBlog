        ...
        <div class="border-b-2 border-neutral-700 pb-10 pt-10 sm:pt-20">
            @forelse($articles as $article)
                ...
                <a href="{{ route('articles.show', $article->slug) }}">
                    <h2
                        class="hover:text-red-700 sm:w-3/5 transition-all text-white sm:pt-0 pt-10 text-3xl sm:text-4xl font-bold sm:pb-2 w-full sm:pt-10 block">
                        {{ $article->title }}
                    </h2>
                </a>
            ...
            @empty
                <h2
                    class="hover:text-red-700 sm:w-3/5 transition-all text-white sm:pt-0 pt-10 text-3xl sm:text-4xl font-bold sm:pb-2 w-full block">
